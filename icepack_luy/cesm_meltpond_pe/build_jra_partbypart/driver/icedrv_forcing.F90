...
! namelist input; initialize the forcing data.
    ...
    !-------------------------------------------------------------------
      ...
      if (trim(atm_data_type(1:8)) == 'NICE_gai')  call atm_NICE_gai
      ...
      if (trim(ocn_data_type(1:4)) == 'NICE_gai')  call ocn_NICE_gai
...
! the time step and the data both start Jan 1.
      ...
      elseif (trim(atm_data_type) == 'NICE_gai') then
...
!=======================================================================
     subroutine atm_NICE_gai
      ...
      character(len=*), parameter :: subname='(atm_NICE_gai)'

!      atm_data_file = 'NICE_atm_forcing.txt'
      filename = trim(data_dir)//'/NICE_2015_gai/'//trim(atm_data_file)
...
!=======================================================================
      ...
      character(len=*), parameter :: subname='(ocn_NICE_gai)'

!      ocn_data_file = 'oceanmixed_daily_3.txt'
      filename = trim(data_dir)//'/NICE_2015_gai/'//trim(ocn_data_file)
