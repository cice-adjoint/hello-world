...
!
      ...
      integer (kind=int_kind), dimension(10000) :: &
         dayofyear , &
         hourofyear
...
!     ! read 08d files
!      print *, 'Reading ','icepack_2005_220_70_08day.txt' 
!      
!      open (12, file='icepack_2005_220_70_08day.txt')
...
!      print *, 'Reading ','icepack_2005_220_70_01hour.txt'

!      open (12, file='icepack_2005_220_70_01hour.txt')
!      read (12 ,*) string11 !headers
...
!      close(12)
      ...
      open (12, file='noise.txt')
      write(12,200) noise
      close(12)
      
      ! observation + noise
      ap_o = apond_timeseries + 0.0*noise
      hp_o = hpond_timeseries + 0.0*noise
...
!!       J = 0.0_dbl_kind
!!      do i = 3096, 5976, 192
!!         T1 = ( sum(ap_g(i: i+191))/192.0_dbl_kind - sum(ap_o(i:i+191))/192.0_dbl_kind )**2
!!         J = J +T1
!!      end do
!
!
