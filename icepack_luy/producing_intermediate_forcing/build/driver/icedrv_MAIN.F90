...
!      write(12 ,300)
      ...
      call icedrv_run ( pndaspect_true , apond_timeseries, hpond_timeseries)
...
!      !-----------------------------------------------------------------
!
!      call icedrv_run ( pndaspect , apond_timeseries, hpond_timeseries)
!
!      ! simulation
...
!      !adj.i.c.
!      !J transpose
!      ad_apnd (n) = 0.0_dbl_kind
!      ad_hpnd (n) = 0.0_dbl_kind
...
!         enddo
!
!         ad_pndaspect_timeseries (istep1) = ad_pndaspect
!
!      enddo
!
!!ad results
...
!
!            data_dir='/THL6/home/xcwang/luy/Icepack-e922/cesm_meltpond_pe/run/data/'
!
!            open(12,file=trim(data_dir)//'melttn_'//char_count//".txt") !
!            read(12,200)melttn
!            close(12)
!
