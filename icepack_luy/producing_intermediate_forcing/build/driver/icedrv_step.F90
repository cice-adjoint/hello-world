...
!write(*,*) "aice       (i)=" , aice       (i)
        ...
        call icepack_step_therm1(dt, ncat, nilyr, nslyr, n_aero,                &
            ...
            yday,  prescribed_ice           , pndaspect, istep1)
      ...
      !-----------------------------------------------------------------
          ...
          !-----------------------------------------------------------------
          ! call luyangoutput_in_step
          !-----------------------------------------------------------------

            print *,'!--------------------------------------------- --------------------'
            print *, '!  call luyangoutput_in_step istep1 = ', istep1
            print *,'!-----------------------------------------------------------------'
...
!            print *,'!-----------------------------------------------------------------'
!            print *, '!  cesm pond adj forcing data_dir =/THL6/home/xcwang/luy/Icepack-e922/intermediate_forcing_data/'
!            print *,'!-----------------------------------------------------------------'

            data_dir='/home/luy/icepack/intermediate_forcing_data/dir2/'
