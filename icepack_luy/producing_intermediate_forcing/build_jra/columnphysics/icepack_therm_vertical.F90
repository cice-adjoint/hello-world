...
!          Elizabeth C. Hunke, LANL
      ...
      !-----------------------------------------------------------------
      ! saving meltpond forcing data
      !
      !-----------------------------------------------------------------
!      call luyangoutput_in_thermo_vertical( aicen, vicen, Tsfc,  meltsn,  melttn, frain , istep1)
      ...
      subroutine luyangoutput_in_thermo_vertical (aicen, vicen, Tsfc,  meltsn,  melttn, frain , istep1)
!      use icedrv_calendar, only: istep, istep1, time, dt, stop_now, calendar
      ...
      integer (kind=int_kind) :: &
         istep1     ! counter, number of steps at current timestep
            ...
            print *,'!-----------------------------------------------------------------'
            print *, '!  cesm pond adj forcing data_dir= /home/luy/icepack/intermediate_forcing_data/dir2/'
            print *,'!-----------------------------------------------------------------'
      ...
      end subroutine luyangoutput_in_thermo_vertical
