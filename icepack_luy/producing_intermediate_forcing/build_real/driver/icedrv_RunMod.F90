...
!  author Elizabeth C. Hunke, LANL
      ...
      subroutine icedrv_run ( pndaspect , apond_timeseries, hpond_timeseries)                        !-------------------------------------------- luyang --------------------------------------------
...
!                 pndaspect = 0.7_dbl_kind
                 ...
                 call ice_step ( pndaspect ,apond_istep, hpond_istep ,istep1)

                 apond_timeseries (istep) = apond_istep
                 hpond_timeseries (istep) = hpond_istep
...
!  author Elizabeth C. Hunke, LANL
      ...
      subroutine ice_step ( pndaspect ,apond_istep, hpond_istep ,istep1)
...
!      call icedrv_diagnostics_debug ('post step_rad, cpl')
      ...
      apond_istep  = sum(trcrn (1,nt_apnd,:) , 1) ! pond area
      hpond_istep  = sum(trcrn (1,nt_hpnd,:) , 1) /5.0_dbl_kind ! pond depth
