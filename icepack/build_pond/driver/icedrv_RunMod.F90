...
!  author Elizabeth C. Hunke, LANL
      ...
      subroutine icedrv_run ( apond_timeseries, hpond_timeseries, aice_timeseries, hice_timeseries )
...
! call compute_ponds_cesm_pndaspect ( istep, pndaspect ) ! luyang,20200425

         call ice_step ( apond_istep, hpond_istep, aice_istep, hice_istep )

         apond_timeseries (istep1) = apond_istep
         hpond_timeseries (istep1) = hpond_istep         

         aice_timeseries (istep1) = aice_istep
         hice_timeseries (istep1) = hice_istep         
...
!  author Elizabeth C. Hunke, LANL
      ...
      subroutine ice_step ( apond_istep, hpond_istep, aice_istep, hice_istep )
...
!         call runtime_diags(dt, istep1, apond_istep )       ! log file
         call runtime_diags(dt, istep, apond_istep, hpond_istep, aice_istep, hice_istep)       ! log file , luyang
